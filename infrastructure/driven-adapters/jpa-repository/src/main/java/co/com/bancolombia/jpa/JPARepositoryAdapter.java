...
@Repository
public class JPARepositoryAdapter extends AdapterOperations<Animales/* change for domain model */, AnimalesEntity/* change for adapter model */, String, JPARepository>
